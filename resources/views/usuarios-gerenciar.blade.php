...
@section('conteudo')
  ...
  <div class="row" style="height: 225px; overflow-y: auto;" ><!--inicio da listagem de users-->
    <div class="col">
    ...
    <div class="row">
      <div class="col d-flex justify-content-around mt-5" id="secao-botoes"> 
        ...
        @if(session('operacao')=='editar')
          ...
          <a href="/user/gerenciar" class="btn btn-lg btn-success"><i class="fas fa-ban">  Cancelar</i></a>
        @else
          <button type="submit" class="btn btn-lg btn-success"><i class="fas fa-check"></i>Localizar</button>          
        @endif
